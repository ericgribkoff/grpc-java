...
public class FullStreamCompressionTest extends AbstractInteropTest {

  @BeforeClass
  public static void turnOnFullStreamCompression() {
    InternalHandlerSettings.enable(true);
    InternalHandlerSettings.autoWindowOn(true);
    startStaticServer(
        NettyServerBuilder.forPort(0)
            .maxMessageSize(AbstractInteropTest.MAX_MESSAGE_SIZE),
        TestServiceImpl.turnOnStreamCompressionInterceptor());
  }
