...
public abstract class ManagedChannel extends Channel {
  ...
  /**
   * Invoking this method triggers tear-down of the channel's name resolver and load
   * balancer, while still allowing on-going RPCs on the channel to continue. New RPCs on the
   * channel will trigger creation of a new connection.
   *
