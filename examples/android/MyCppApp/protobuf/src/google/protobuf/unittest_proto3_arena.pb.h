...
class TestAllTypes : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto3_arena_unittest.TestAllTypes) */ {
 ...
 public:
  ...
  void _slow_set_allocated_optional_lazy_import_message(
      ::google::protobuf::Arena* message_arena, ::protobuf_unittest_import::ImportMessage** optional_lazy_import_message);
  ::protobuf_unittest_import::ImportMessage* _slow_release_optional_lazy_import_message();
  public:
...
inline void TestAllTypes::clear_optional_lazy_import_message() {
